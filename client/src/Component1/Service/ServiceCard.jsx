...
const ServiceCard = ({
  ...
  return (
  <div className='service-box rounded-lg shadow-cases bg-white group relative z-10 overflow-hidden p-5'>
      <div className='relative'>
        {/* fixed responsive thumbnail area to keep cards balanced */}
        <div className='overflow-hidden h-[220px] sm:h-[240px] md:h-[260px] lg:h-[300px] xl:h-[320px] relative'>
          <img
            src={serviceThumb}
            draggable='false'
